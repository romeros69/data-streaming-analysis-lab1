...
- [Лабораторная работа по потоковому анализу данных 1](#лабораторная-работа-по-потоковому-анализу-данных-1)
  - [Содержание](#содержание)
  - [Описание](#описание)
  - [Запуск](#запуск)
    - [Отправка логов в stdout](#отправка-логов-в-stdout)
    - [Отправка логов в kafka](#отправка-логов-в-kafka)
